...
.apigateway$get_domain_names_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(position = structure(logical(0), tags = list(type = "string")), items = structure(list(structure(list(domainName = structure(logical(0), tags = list(type = "string")), certificateName = structure(logical(0), tags = list(type = "string")), certificateArn = structure(logical(0), tags = list(type = "string")), certificateUploadDate = structure(logical(0), tags = list(type = "timestamp")), regionalDomainName = structure(logical(0), tags = list(type = "string")), regionalHostedZoneId = structure(logical(0), tags = list(type = "string")), regionalCertificateName = structure(logical(0), tags = list(type = "string")), regionalCertificateArn = structure(logical(0), tags = list(type = "string")), distributionDomainName = structure(logical(0), tags = list(type = "string")), distributionHostedZoneId = structure(logical(0), tags = list(type = "string")), endpointConfiguration = structure(list(types = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(type = "list")), vpcEndpointIds = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(type = "list"))), tags = list(type = "structure")), domainNameStatus = structure(logical(0), tags = list(type = "string")), domainNameStatusMessage = structure(logical(0), tags = list(type = "string")), securityPolicy = structure(logical(0), tags = list(type = "string")), tags = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(type = "map")), mutualTlsAuthentication = structure(list(truststoreUri = structure(logical(0), tags = list(type = "string")), truststoreVersion = structure(logical(0), tags = list(type = "string")), truststoreWarnings = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(type = "list"))), tags = list(type = "structure"))), tags = list(type = "structure"))), tags = list(locationName = "item", type = "list"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
