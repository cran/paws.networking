...
.apigatewayv2$update_integration_input <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(ApiId = structure(logical(0), tags = list(location = "uri", locationName = "apiId", type = "string")), ConnectionId = structure(logical(0), tags = list(locationName = "connectionId", type = "string")), ConnectionType = structure(logical(0), tags = list(locationName = "connectionType", type = "string")), ContentHandlingStrategy = structure(logical(0), tags = list(locationName = "contentHandlingStrategy", type = "string")), CredentialsArn = structure(logical(0), tags = list(locationName = "credentialsArn", type = "string")), Description = structure(logical(0), tags = list(locationName = "description", type = "string")), IntegrationId = structure(logical(0), tags = list(location = "uri", locationName = "integrationId", type = "string")), IntegrationMethod = structure(logical(0), tags = list(locationName = "integrationMethod", type = "string")), IntegrationType = structure(logical(0), tags = list(locationName = "integrationType", type = "string")), IntegrationUri = structure(logical(0), tags = list(locationName = "integrationUri", type = "string")), PassthroughBehavior = structure(logical(0), tags = list(locationName = "passthroughBehavior", type = "string")), PayloadFormatVersion = structure(logical(0), tags = list(locationName = "payloadFormatVersion", type = "string")), RequestParameters = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(locationName = "requestParameters", type = "map")), RequestTemplates = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(locationName = "requestTemplates", type = "map")), TemplateSelectionExpression = structure(logical(0), tags = list(locationName = "templateSelectionExpression", type = "string")), TimeoutInMillis = structure(logical(0), tags = list(locationName = "timeoutInMillis", type = "integer"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
