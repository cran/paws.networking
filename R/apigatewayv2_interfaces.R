...
.apigatewayv2$get_apis_output <- function(...) {
  args <- c(as.list(environment()), list(...))
  shape <- structure(list(Items = structure(list(structure(list(ApiEndpoint = structure(logical(0), tags = list(locationName = "apiEndpoint", type = "string")), ApiId = structure(logical(0), tags = list(locationName = "apiId", type = "string")), ApiKeySelectionExpression = structure(logical(0), tags = list(locationName = "apiKeySelectionExpression", type = "string")), CreatedDate = structure(logical(0), tags = list(locationName = "createdDate", type = "timestamp", timestampFormat = "iso8601")), Description = structure(logical(0), tags = list(locationName = "description", type = "string")), DisableSchemaValidation = structure(logical(0), tags = list(locationName = "disableSchemaValidation", type = "boolean")), Name = structure(logical(0), tags = list(locationName = "name", type = "string")), ProtocolType = structure(logical(0), tags = list(locationName = "protocolType", type = "string")), RouteSelectionExpression = structure(logical(0), tags = list(locationName = "routeSelectionExpression", type = "string")), Version = structure(logical(0), tags = list(locationName = "version", type = "string")), Warnings = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(locationName = "warnings", type = "list")), Tags = structure(list(structure(logical(0), tags = list(type = "string"))), tags = list(locationName = "tags", type = "map"))), tags = list(type = "structure"))), tags = list(locationName = "items", type = "list")), NextToken = structure(logical(0), tags = list(locationName = "nextToken", type = "string"))), tags = list(type = "structure"))
  return(populate(args, shape))
}
